...
- Wallet after the roundtrip: **4.777677715 SOL** (session debit **0.000250622 SOL**, comprising **0.000250000 SOL** in transaction fees across the eight receipts plus a **0.000000622 SOL** non-fee debit during deposit-intent initialization at slot 498692075, receipt [`vKh8cM…`](https://explorer.solana.com/tx/vKh8cMu14HhbPK3syDBnWPZR6hzv5FhvdAmPBLU54hUt7RMSDLsspS7FE3FtpPHyWKphz22nhrcGZXichy6ahBs?cluster=devnet), for account rent/resize funded by the wallet; bounty WSOL returned to the wallet's WSOL account), **3.750623 SDK-USDC**, **198494** shares (`5NtgPkFiSqbP1H3Xgk3L48ioWLJouPFivaUqWJKQmhMZ`). Vault: **0.2 SDK-USDC**, 0 WSOL, share supply **199990**, no open intents, `activeRebalance` 0.
