...
export const CASH_OUT_BEFORE_SIGN = "Cash out in one signature. If the vault's USDC buffer covers it, you get USDC right away; otherwise the keeper sells your share and usually settles in USDC within about a minute. Any stock that cannot be sold is sent to you as the token, or you can claim your share in kind yourself after the 10-minute request timeout.";
export const CASH_OUT_STILL_NOTE = "These holdings are still on this cash-out. The keeper usually sells them and settles in USDC within about a minute. Any stock that cannot be sold is sent to you as the token, or you can claim your share in kind yourself after the 10-minute request timeout.";
