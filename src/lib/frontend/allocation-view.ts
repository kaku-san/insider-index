import type { SliceMark } from "./slice-notes.ts";
/** Presentation only: never changes the definition used to invest or rebalance. */
export type AllocationInput = { ticker: string; name?: string | null; weightBps: number; mint?: string | null; issuer?: string | null; tokenSymbol?: string | null; network?: string | null; detail?: string | null; sliceMark?: SliceMark };
