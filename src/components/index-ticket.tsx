  ...
  return <div className="index-page">
    ...
    <div className="order-layout"><div className="order-information">
      ...
      <section className="how-it-works"><span className="mini-label">NATIVE VAULT LIFECYCLE · NOT YET ENABLED</span>
        ...
        <div><span>03</span><p><strong>Targets and USDC exit</strong>Policy-valid targets and eligible normal rebalances do not require holder signatures. Exit is USDC-only via zap once create→mint→rebalance→USDC-out has a receipt. Public Invest Sign stays off until then.</p></div>
      </section>
      ...
      <div className="order-summary"><div><span>Host entry fee</span><strong>{VAULT_RELEASE.hostEntryFeeBps} bps (0.25%)</strong></div><div><span>Host exit fee</span><strong>0</strong></div><div><span>Native exit</span><strong>USDC zap (unproven)</strong></div><div><span>Actual position</span><strong>Not connected</strong></div></div>
