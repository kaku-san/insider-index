...
type UI = {theme:Theme; setTheme:(v:Theme)=>void; query:string; setQuery:(v:string)=>void; lane:Lane;setLane:(v:Lane)=>void; toast:(v:string)=>void; saved:string[];toggleSave:(id:string)=>void;};
