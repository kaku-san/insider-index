...
export function SiteHeader() {
  ...
  return <>
    <aside className="sidebar">
      <Link href="/" className="brand" aria-label="InsiderIndex home"><BrandMark /><span>InsiderIndex</span></Link>
    ...
    <header className="site-header">
      <div className="header-left"><Link href="/" className="brand mobile-brand" aria-label="InsiderIndex home"><BrandMark /><span>InsiderIndex</span></Link><span className="header-breadcrumb">{crumb(path)}</span></div>
