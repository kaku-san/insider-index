...
These are native execution/accounting tests, not a funded release or finished pilot. Seven DEX-backed acquisition/conversion legs, production finalized-receipt credit decoding, end-to-end limits/recovery and live approvals remain unproved. The one-credit reverse conversion is a local deployed-program execution proof, not an on-chain receipt or a completed seven-leg exit. Public funds/Invest/USDC-exit flags remain off. No wallet UX is enabled by these fixtures.
