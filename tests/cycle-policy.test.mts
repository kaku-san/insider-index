...
function policy(r = record()): CyclePolicy { return { schema: "insiderindex-cycle-policy-v1", indexId: r.indexId, vault: r.vaultAddress!, shareMint: r.shareMint!, definitionHash: cycleDefinitionHash(r), owner, keeper, operationId: "00000000-0000-4000-8000-000000000001", expiresAt: Date.now() + 60000, approvalReference: null, feeScheduleHash: null, financialExecutionAuthorized: false,
